...
namespace FilterDataGrid
{
    ...
    public class Loc
    {
        ...
        // -----------------------------------------
        // Filter Condition
        public string NotEquals => Translate("Does not equal");
        public string BeginsWith => Translate("Begins With");
        public string EndsWith => Translate("Ends With");
        public string DoesNotContain => Translate("Does not contain");
